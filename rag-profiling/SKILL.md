...
문서 맨 앞 `개요` 절(목차 0번)이 이 네 단과 산출물의 목적을 독자에게 먼저 안내한다.
...
**그리고 크기를 정한다. 본선은 30분(9,000자 안쪽)이고 나머지는 상세와 부록으로 내린다.**
분량 기준이 없으면 규칙을 다 지키면서도 문서가 무한히 자란다. 루프는 늘리기만 하기 때문이다.
층을 가르는 법은 `references/narrative.md` 의 `발표에는 시간이 있다`.
